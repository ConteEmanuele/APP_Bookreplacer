...
<body>
    ...
    <main class="container-fluid d-flex">
        ...
        <div class="container-fluid d-flex justify-content-center align-self-center">
            ...
            <form action="php/registration.php" method="POST" class=" d-flex flex-column p-5 border border-2 rounded">
        
                <div class="form-group">
                    <input type="text" name="name" id="name" placeholder="Inserisci nome" required ="required" class="form-control">
                </div>
                <div class="form-group">
                    <input type="text" name="surname" id="surname" placeholder="Inserisci cognome" required ="required" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group d-flex justify-content-center">
                    <button type="submit" id="submit" name="submit" class="btn btn-primary btn-form">Registrati</button>
                </div>
